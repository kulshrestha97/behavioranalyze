...
twitter_data = read.csv(file="C:/Users/rajat/Documents/STUDY/WEB MINING/results_dataset.csv", header=TRUE,sep=",",encoding="UTF-8", stringsAsFactors = FALSE)
...
text_corpus = tm_map(text_corpus, removeWords, c(stopwords("")))
